...
if __name__ == "__main__":
    ...
    if TRAIN:
        train_agents(state_dim, action_dim, all_architecures, all_activations, nb_model, total_episodes = 2500)
    ...
    if TEST:
        ...
        noise_type = 1
        sigma_frac = 0
        test_alone_index = 8 #index of the network to be tested alone, without voting rule, -1 for none
        total_episodes = 3
        ...
        for voting_rule in all_rules:
            ...
            list_rewards.append(run_simulation(voting_rule, networks, sigma_frac, total_episodes, test_alone_index, noise_type, eps_length = 200))
